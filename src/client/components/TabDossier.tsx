      ...
      <div className="border border-[var(--border-main)] p-6 sm:p-8 bg-[var(--bg-card)] space-y-6 max-w-lg mx-auto">
        ...
        <div className="space-y-3 pt-1">
          ...
          <div className="space-y-2 pt-0.5">
            {/* 1. Publicar diretamente nos comentarios do Reddit */}
            <button
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              {/* 3. Copiar Markdown para Area de Transferencia */}
              <button
                onClick={onCopyShare}
                className="h-10 border border-[var(--border-main)] bg-[var(--bg-card)] text-[var(--text-main)] hover:bg-[var(--bg-card-alt)] font-mono text-[10px] font-medium tracking-widest uppercase transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
              >
            ...
            {/* 4. Portal Externo DestinyVox 360 (Neutro e Seguro) */}
            <button
              type="button"
              onClick={onOpenPortal}
              className="w-full h-10 border border-[var(--border-main)] hover:border-[var(--text-main)] bg-[var(--bg-card)] hover:bg-[var(--bg-card-alt)] font-mono text-[10px] tracking-[0.15em] text-[var(--text-main)] uppercase transition-all duration-150 flex items-center justify-center gap-1.5 cursor-pointer"
            >
